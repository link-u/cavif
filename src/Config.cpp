...
clipp::group Config::createCommandLineFlags() {
  ...
  auto multiPass = (
      ...
      option("--disable-multi-pass-encoding").doc("Disable multipass encoding (default)").set(multiPassEncoding, false)
   );
  ...
  return (io, meta, av1, multiPass, color, scales, pixelAndColor, multiThreading, rateControl, preProcess, postProcess, codingParameters) | support;
}
